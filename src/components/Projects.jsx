...
const rawCategories = [
  {
    id: 'web-projects',
    title: 'Web Projects',
    desc: 'Government and business portals for seedling dispersal, research submission, remittances, and payroll.',
    color: '#3b82f6',
    type: 'image',
    kicker: 'Development vault',
    unit: 'projects',
    items: devItems('web', [
      ['seedling-portal.png', 'CAGRO Seedling Portal — Admin', 'PHP · MySQL · HTML · CSS · JavaScript'],
  ...
  },
  {
    ...
    desc: 'Mobile-first apps for marketplace ordering and workforce attendance monitoring.',
    color: '#10b981',
    type: 'image',
    kicker: 'Development vault',
    unit: 'projects',
  ...
  },
  {
    ...
    desc: 'Native desktop software for clinic records and warehouse inventory control.',
    color: '#f43f5e',
    type: 'image',
    kicker: 'Development vault',
    unit: 'projects',
